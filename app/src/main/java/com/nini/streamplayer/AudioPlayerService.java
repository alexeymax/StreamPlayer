 ...
 */
public class AudioPlayerService implements OnCompletionListener, OnPreparedListener, OnErrorListener, StreamPlayerService.PlayThreadListener {
...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    public void destroy() {
        ...
        if (this.player != null) {
            ...
            StreamPlayerService.actionStop(context);
            this.player = null;
        }
    ...
    public void updateNotification(String title, String text) {
        ...
        if (mStreamPlayerService != null) {
            mStreamPlayerService.updateNotification(title, text);
        }
    }
    ...
    public void pausePlaying() {
        StreamPlayerService.actionPlayPause(context);
    }
    ...
    private boolean readyPlayer(final String file) {
        ...
        Intent mStreamPlayerServiceIntent = new Intent(context, StreamPlayerService.class);

        Log.i("", "songURL: ****** " + file);
        mStreamPlayerServiceIntent.putExtra("url", file);
        context.bindService(mStreamPlayerServiceIntent, channelPlayingServiceConnection, Context.BIND_AUTO_CREATE);
    ...
    ServiceConnection channelPlayingServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            Log.d("", "onServiceConnected: channelPlayingServiceConnection");

            StreamPlayerService.actionPlayPause(context);

            mStreamPlayerService = ((StreamPlayerService.LocalBinder) iBinder).getService();
            mStreamPlayerService.setListener(AudioPlayerService.this);
